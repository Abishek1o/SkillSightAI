      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Skill Gap Analysis Results</h1>
              <p className="text-gray-600">Target Position: {analysisData.role}</p>
            </div>
            <div className="flex gap-3 no-print">
              <button
                onClick={handleExportPDF}
                className="px-4 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-all flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="relative w-64 h-64 mx-auto">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-gray-600 font-medium mt-2">Match Score</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                ...
                <p className="text-3xl font-bold text-green-900 mb-1">{matchedSkills.length}</p>
                <p className="text-green-700 font-medium">Matched Skills</p>
              </div>
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border border-orange-200">
                <XCircle className="w-8 h-8 text-orange-600 mb-3" />
                <p className="text-3xl font-bold text-orange-900 mb-1">{missingSkills.length}</p>
                <p className="text-orange-700 font-medium">Missing Skills</p>
              </div>
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-6 border border-indigo-200">
                <TrendingUp className="w-8 h-8 text-indigo-600 mb-3" />
                <p className="text-3xl font-bold text-indigo-900 mb-1">Good</p>
                <p className="text-indigo-700 font-medium">Match Level</p>
              </div>
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-6 border border-cyan-200">
                ...
                <p className="text-3xl font-bold text-cyan-900 mb-1">{learningPaths.length}</p>
                <p className="text-cyan-700 font-medium">Learning Paths</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Your Matched Skills</h2>
            </div>
              ...
              {matchedSkills.map((skill, index) => (
                <div key={index} className="p-4 bg-green-50 rounded-xl border border-green-200">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-green-600 font-bold">{skill.proficiency}%</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              {missingSkills.map((skill, index) => (
                <div key={index} className="p-4 bg-orange-50 rounded-xl border border-orange-200 hover:bg-orange-100 transition-colors">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Curated courses to help you bridge the skill gap</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {learningPaths.map((path) => (
              <div
                ...
                className="border border-gray-200 rounded-2xl p-6 hover:shadow-lg hover:border-indigo-300 transition-all cursor-pointer group"
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">{path.platform}</span>
                </div>
              </div>
            ))}
          </div>
